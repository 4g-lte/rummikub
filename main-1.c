...
void putkeep(struct card* keep, struct card* cards, struct card* setting);
//주머니에 카드를 넣는다.
//setting에는 나중에 정리하기위해 '0'으로 표시해준다.
void takeoutkepp(struct card* keep, struct card* cards, struct card* setting);
//주머니에서 카드를 꺼낸다.
        ...
        if (playercards[turn].size == 0) {//플레이어의 카드 숫자가 0장이라면 다음 사람으로 넘어간다.
            ...
            while (1) {
                ...
                if (control == 1) {
                    ...
                    putkeep(keep, cards, setting);
                }
                else if (control == 3) {
                    takeoutkeep(keep, cards, setting);
                }
                else if (control == 4) {
                    while (1) {
                    ...
                    if (b == -1) {
                        ...
                        case 1:
                            (playercards[turn].owncard[a])->color[0] = 'b';
                            (playercards[turn].owncard[a])->color[0] = 'l';
                            (playercards[turn].owncard[a])->color[0] = 'u';
                            (playercards[turn].owncard[a])->color[0] = 'e';
                            (playercards[turn].owncard[a])->color[0] = '\0';
                            break;
                        case 2:
                            (playercards[turn].owncard[a])->color[0] = 'r';
                            (playercards[turn].owncard[a])->color[0] = 'e';
                            (playercards[turn].owncard[a])->color[0] = 'd';
                            (playercards[turn].owncard[a])->color[0] = '\0';
                            break;
                        case 3:
                            (playercards[turn].owncard[a])->color[0] = 'b';
                            (playercards[turn].owncard[a])->color[0] = 'l';
                            (playercards[turn].owncard[a])->color[0] = 'a';
                            (playercards[turn].owncard[a])->color[0] = 'c';
                            (playercards[turn].owncard[a])->color[0] = 'k';
                            (playercards[turn].owncard[a])->color[0] = '\0';
                            break;
                        case 4:
                            (playercards[turn].owncard[a])->color[0] = 'o';
                            (playercards[turn].owncard[a])->color[0] = 'r';
                            (playercards[turn].owncard[a])->color[0] = 'a';
                            (playercards[turn].owncard[a])->color[0] = 'n';
                            (playercards[turn].owncard[a])->color[0] = 'g';
                            (playercards[turn].owncard[a])->color[0] = 'e';
                            (playercards[turn].owncard[a])->color[0] = '\0';
                            break;
                        }
